"""
Django settings for DLK project.
...
SECRET_KEY = 'django-insecure-i-^qc7qukquik*p6a4sqb-0y$jb2zf0m87fgqf%_=^ktm$99$e'
...
WSGI_APPLICATION = 'DLK.wsgi.application'
